...
export const messages = {
  en: {
    ...
    remove: "Remove",
    delete: "Delete",
    cannotDeleteSelf: "You cannot delete your own login account or employee record.",
    ...
    codeUppercaseUnderscoreOnly:
      "Code can only contain uppercase letters and underscores.",
  ...
  "zh-CN": {
    ...
    remove: "移除",
    delete: "删除",
    cannotDeleteSelf: "不能删除当前登录账号或对应员工档案。",
    updatePassword: "修改密码",
    ...
    codeUppercaseUnderscoreOnly: "编码只能包含大写字母和下划线。",
...
const zhErrorMessages: Record<string, string> = {
  ...
  "Permission code already exists": "权限编码已存在",
